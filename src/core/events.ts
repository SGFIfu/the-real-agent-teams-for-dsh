...
export const TASK_READY = 'agent-teams/task-ready';
export const TASK_UNSCHEDULABLE = 'agent-teams/task-unschedulable';
export const WORKER_WAKEUP_REQUESTED = 'agent-teams/worker-wakeup-requested';
export const WORKER_WAKEUP_FAILED = 'agent-teams/worker-wakeup-failed';
export const WORKER_WAKEUP_RETRY_FAILED = 'agent-teams/worker-wakeup-retry-failed';
...
export const MESSAGE_QUEUED = 'agent-teams/message-queued';
export const MESSAGE_DELIVERED = 'agent-teams/message-delivered';
export const MESSAGE_ACKNOWLEDGED = 'agent-teams/message-acknowledged';

export const CAPABILITY_DECISION = 'agent-teams/capability-decision';
...
export const ALL_EVENTS = [
  ...
  TASK_READY,
  TASK_UNSCHEDULABLE,
  WORKER_WAKEUP_REQUESTED,
  WORKER_WAKEUP_FAILED,
  WORKER_WAKEUP_RETRY_FAILED,
  MESSAGE_SENT,
