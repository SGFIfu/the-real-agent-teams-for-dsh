...
export type TeamMemberId = string & { readonly [memberIdBrand]: true };
...
export type FileClaimId = string & { readonly [fileClaimIdBrand]: true };
export type WorkspaceId = string & { readonly [workspaceIdBrand]: true };
export type GitWorkspaceId = string & { readonly [gitWorkspaceIdBrand]: true };
export type CommitId = string & { readonly [commitIdBrand]: true };
export type ReviewRequestId = string & { readonly [reviewRequestIdBrand]: true };
export type ReviewResultId = string & { readonly [reviewResultIdBrand]: true };
export type RuntimeEventId = string & { readonly [runtimeEventIdBrand]: true };
