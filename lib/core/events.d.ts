...
export declare const TASK_READY = "agent-teams/task-ready";
export declare const TASK_UNSCHEDULABLE = "agent-teams/task-unschedulable";
export declare const WORKER_WAKEUP_REQUESTED = "agent-teams/worker-wakeup-requested";
export declare const WORKER_WAKEUP_FAILED = "agent-teams/worker-wakeup-failed";
export declare const WORKER_WAKEUP_RETRY_FAILED = "agent-teams/worker-wakeup-retry-failed";
...
export declare const MESSAGE_QUEUED = "agent-teams/message-queued";
export declare const MESSAGE_DELIVERED = "agent-teams/message-delivered";
export declare const MESSAGE_ACKNOWLEDGED = "agent-teams/message-acknowledged";
export declare const CAPABILITY_DECISION = "agent-teams/capability-decision";
...
export declare const ALL_EVENTS: readonly ["agent-teams/team-created", "agent-teams/team-completed", "agent-teams/team-failed", "agent-teams/member-joined", "agent-teams/member-left", "agent-teams/member-status", "agent-teams/task-created", "agent-teams/task-claimed", "agent-teams/task-completed", "agent-teams/task-failed", "agent-teams/task-released", "agent-teams/task-blocked", "agent-teams/task-ready", "agent-teams/task-unschedulable", "agent-teams/worker-wakeup-requested", "agent-teams/worker-wakeup-failed", "agent-teams/worker-wakeup-retry-failed", "agent-teams/message-sent", "agent-teams/message-delivery-failed", "agent-teams/message-queued", "agent-teams/message-delivered", "agent-teams/message-acknowledged", "agent-teams/capability-decision", "agent-teams/plan-submitted", "agent-teams/plan-approved", "agent-teams/plan-rejected", "agent-teams/file-claimed", "agent-teams/file-released", "agent-teams/file-conflict", "agent-teams/finding-added", "agent-teams/finding-resolved"];
